...
using System.Linq;
using Retail.Telegram.Bot.DataAccess.DataManager.Interface;

namespace Retail.Telegram.Bot.DataAccess.DataManager.Extension
{
    public static class DataAccessExtension
    {
        ...
        {
            return global::Retail.Telegram.Bot.DataAccess.DataManager.Extension.DataObjectExtension
                .ToEnum<T>(instance[columnName]);
        }

        public static T ToEnum<T>(this IDataManager instance, string parameterName) where T : struct
        {
            return global::Retail.Telegram.Bot.DataAccess.DataManager.Extension.DataObjectExtension.ToEnum<T>(
        ...
        {
            return global::Retail.Telegram.Bot.DataAccess.DataManager.Extension.DataObjectExtension.ToType<T>(
                instance[parameterName].Value);
        }
